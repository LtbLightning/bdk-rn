...
export class CanonicalTx {
   ...
   */
  static async createCanonicalTx(transactionId: string, chainPositionId: string): Promise<string> {
    try {
   ...
   */
  static async getCanonicalTxById(id: string): Promise<CanonicalTx> {
    try {
