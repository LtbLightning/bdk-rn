...
export class Wallet extends NativeLoader {
    ...
    async getAddress(addressIndex) {
        ...
        return new AddressInfo(addressInfo.index, new Address()._setAddress(addressInfo.address), getKeychainKind(addressInfo.keychain));
    }
    /**
     ...
     * @returns {Promise<AddressInfo>}
     */
    async getInternalAddress(addressIndex) {
