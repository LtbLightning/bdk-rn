...
class BdkInterface {
    ...
    async initWallet(args) {
        try {
            ...
            const wallet = await this._bdk.initWallet(mnemonic, password, network, blockChainConfigUrl, blockChainSocket5, retry, timeOut, blockChainName, useDescriptor ? descriptor : '');
